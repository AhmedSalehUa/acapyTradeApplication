...
public class costsAdapter extends ArrayAdapter<costs> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView orderNum=(TextView)convertView.findViewById(R.id.cost_orderNum);
        orderNum.setText(items.getOrderNum());

        TextView amount=(TextView)convertView.findViewById(R.id.cost_amount);
