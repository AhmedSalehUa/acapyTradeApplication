...
import com.acpay.acapytrade.Order.progress.boxes;
import com.acpay.acapytrade.Order.progress.boxesAdapter;
import com.acpay.acapytrade.Order.progress.progressReponser;
...
public class OrderPendingFragement extends Fragment {
    ...
    public OrderPendingFragement(Order order) {
        this.order = order;
                ...
                builder.setMessage("تم مراجعة الاوردر انت على وشك حذفة")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(@SuppressWarnings("unused") final DialogInterface dialog, @SuppressWarnings("unused") final int id) {
                                ...
                                final OrderDone orderDone = new OrderDone(order, "delete");
                                final Handler handler = new Handler();
                                Runnable runnableCode = new Runnable() {
                                    @Override
                                    public void run() {
    ...
    private void onBackPressed() {
        getFragmentManager().beginTransaction().replace(R.id.pending_container, new OrderPended()).commit();
    }
