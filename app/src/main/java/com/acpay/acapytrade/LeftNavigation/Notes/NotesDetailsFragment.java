...
public class NotesDetailsFragment extends Fragment {
    ...
    public NotesDetailsFragment(BottomNavigationView bottomNav, String name) {
        super();
                                ...
                                Runnable runnableCode = new Runnable() {
                                    ...
                                    public void run() {
                                        if (updatea.isFinish()) {
                                            ...
                                            getFragmentManager().beginTransaction().replace(R.id.transition_container, new NotesDetailsFragment(bottomNav,name)).commit();
