...
import com.acpay.acapytrade.LeftNavigation.Transitions.Pay.TransitionsApiUpdate;
...
public class NotesDevicesFragment extends Fragment {
    BottomNavigationView bottomNav;
    String name;

    public NotesDevicesFragment(BottomNavigationView bottomNav, String name) {
        super();
                                ...
                                Runnable runnableCode = new Runnable() {
                                    ...
                                    public void run() {
                                        if (updatea.isFinish()) {
                                            ...
                                            getFragmentManager().beginTransaction().replace(R.id.transition_container, new NotesDevicesFragment(bottomNav, name)).commit();
