...
public class NotesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomNav = (BottomNavigationView) rootview.findViewById(R.id.notes_navigation);
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.nav_notes_places:
                        getFragmentManager().beginTransaction().replace(R.id.notes_container, new NotesPlacesFragment(bottomNav)).commit();
                        break;
        ...
        enableBottomNav();
        bottomNav.setSelectedItemId(R.id.nav_notes_places);
        disableBottomNav();
